...
public class DesignTacoController {
    ...
    @PostMapping
    public String processDesign(@Valid Taco taco, Errors errors) { //Without explicit specifying the submission of the form will send a post
        if (errors.hasErrors()) {
            return "design";
        }

        // Save the taco design...           //request to the same controller
